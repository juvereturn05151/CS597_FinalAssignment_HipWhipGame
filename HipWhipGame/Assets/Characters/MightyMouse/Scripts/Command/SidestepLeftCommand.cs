...
{
    public class SidestepLeftCommand : ICommand
    {
        private FighterComponentManager fighterComponentManager;
        private MoveData moveData;
        public string Name => "SidestepLeft";

        public SidestepLeftCommand(FighterComponentManager fighterComponentManager, MoveData moveData)
        {
        ...
        public void Pressed()
        {
            ...
            {
                Debug.Log("Sidestep Left Pressed");
